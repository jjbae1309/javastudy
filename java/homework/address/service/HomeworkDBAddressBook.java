package homework.address.service;
...
public class HomeworkDBAddressBook implements com.jjbae.address.service.AddressBookIf {
	private static Logger LOGGER = LoggerFactory.getLogger(HomeworkDBAddressBook.class);
	...
	public HomeworkDBAddressBook(String driverName, String url, String user, String password) {
		try {
